...
### 建置
1. 用 k3d [建 local registry、cluster](https://hackmd.io/247PuafWT3eRMPcJw2hQgQ)。
2. 安裝 [argocd](https://hackmd.io/zdcctXp5Szm3aBF6llj7Jg)。
3. 信任 repos：
  ```bash
  make connect
  ```
...
### knative extensions 來源
- [rabbitmq-source](https://knative.dev/docs/eventing/sources/rabbitmq-source/)
- [net-istio](https://knative.dev/docs/install/installing-istio/#installing-istio)